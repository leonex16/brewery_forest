...
part of 'obdb_brewery_res.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ObdbBreweryRes _$ObdbBreweryResFromJson(Map<String, dynamic> json) =>
    ObdbBreweryRes(
...
Map<String, dynamic> _$ObdbBreweryResToJson(ObdbBreweryRes instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
