...
class ObdbBreweriesResHiveAdapter extends TypeAdapter<ObdbBreweriesRes> {
  @override
  int get typeId => 10;

  @override
  ObdbBreweriesRes read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return ObdbBreweriesRes(
  ...
  @override
  void write(BinaryWriter writer, ObdbBreweriesRes obj) {
    writer
      ..writeByte(16)
      ..writeByte(0)
      ..write(obj.id)
